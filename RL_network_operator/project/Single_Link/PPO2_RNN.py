...
TOTAL_BANDWIDTH = 10
dist1 = StaticRequestType(id=0, bandwidth=2, coming_rate=0.5, service_rate=1)
dist2 = StaticRequestType(id=1, bandwidth=5, coming_rate=0.5, service_rate=1)
dist3 = ElasticRequestType(id=2, bandwidth_list=[2,8], coming_rate=3,\
    service_rate=3, distribution=[0.9, 0.1],\
...
validate_env_dir = open('10-300-3_valid_env_list.obj', 'rb')
validate_env_list = pickle.load(validate_env_dir)
test_env_dir = open('10-300-3_test_env_list.obj', 'rb')
