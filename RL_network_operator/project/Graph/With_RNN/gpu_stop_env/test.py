...
import sys
sys.path.append('.')
from environment.util import evaluate_reject_when_full, evaluate, evaluate_totally_random
from environment.env_generator import produce_env
...
# from environment.util import evaluate_reject_when_full
...
if __name__ == '__main__':
    # print('--,', evaluate_reject_when_full('environment/env_list_set2'))
