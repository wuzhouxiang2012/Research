...
class PDModel(nn.Module):
    def __init__(self, obs_size, action_size):
        ...
        self.Qfc1 = nn.Linear(obs_size, hidden_size)
        self.Qfc2 = nn.Linear(hidden_size, action_size)
        self.Afc1 = nn.Linear(obs_size, hidden_size)
        self.Afc2 = nn.Linear(hidden_size, action_size)
