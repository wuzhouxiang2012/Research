...
def main():
    ...
    while episode < max_episode:  # 训练max_episode个回合，test部分不计算入episode数量
        ...
        # test part
        eval_reward, num_accpet = evaluate(env, agent, render=True)  # render=True 查看显示效果
        logger.info('episode:{}    e_greed:{}   Test reward:{} Num of accept:{}'.format(
            episode, agent.e_greed, eval_reward, num_accpet))
